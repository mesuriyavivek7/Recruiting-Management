...
const RecruitSignUp = () => {
  ...
  return (
    <main>
      <div className="login-content-container h-screen flex relative overflow-hidden">
        <div className="login-form w-[38%] h-full overflow-y-scroll relative">
        ...
        <div className="login-image w-[62%] h-screen relative bg-gradient-to-b from-orange-800 to-orange-900">
          {renderFormImage()}
        </div>
      </div>
    </main>
