...
export const formSchema = z.object({
    ...
    expected_salary:z.coerce.number({invalid_type_error:'expected salary must be a number'})
        ...
        .refine((val) => val < 1000, "Expected salary cannot exceed 999 lacs").optional(),
    key_skills:z.array(z.string().min(1)).optional(),
    may_also_know:z.array(z.string().min(1)).optional(),
