...
function PostJobForm2({ onNext, onPrev, onFormDataChange, jobid, parentFormData}) {
      ...
      <div className="custom-div place-items-end pb-2">
        <div className="flex gap-2">
          ...
          <button
           ...
           className="py-1 px-4 text-base bg-blue-600 hover:bg-blue-700 rounded-sm text-white"
           >
            Next
          </button>
        </div>
