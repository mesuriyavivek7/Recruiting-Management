...
function PostJobForm1({ onNext, onFormDataChange, jobId, parentFormData}) {
  ...
  const validate = () => {
    ...
    else if (formData.minExperience && formData.maxExperience && (formData.minExperience > formData.maxExperience))newErrors.experience = "Max Experience cannot be less than Min Experience.";
