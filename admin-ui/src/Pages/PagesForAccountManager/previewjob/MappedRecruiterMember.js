...
import { mappedColumns } from '../RecruitingAgency/RowColMappedReMember';
import axios from 'axios'
import WhiteLoader from '../../../assets/whiteloader.svg'

function MappedRecruiterMember({jobId,jobStatus,getDashboardCounts,showNotification}) {
  ...
  const [verifiedRecruiterMember,setVerifiedRecruiterMember]= useState([])
...
const calculateRowHeight = (params) => {
  ...
  return (
    ...
    <Box display="flex" justifyContent="space-between" alignItems="center" mb={2} gap={2} p={2}>
    {/* Search Bar */}
    <TextField
      label="Search..."
      variant="outlined"
