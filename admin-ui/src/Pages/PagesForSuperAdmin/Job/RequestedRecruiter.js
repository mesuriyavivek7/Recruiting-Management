...
import { fetchRecruiterMemberDetails, fetchRequestedRecruiterIds } from '../../../services/api';
import Notification from '../../../Components/Notification';
import { mappedColumns  } from '../RecruitingAgency/RowColMappedReMember';
export default function RequestedRecruiter({ jobId }) {
    ...
    <>
      ...
      <div className='mt-8'>
        ...
        <Box sx={{ height: 600, width: '100%', paddingTop: '19px' }}>
          <DataGrid
            rows={recruiterData}
            columns={mappedColumns(recruiterData)}
            rowHeight={80}
